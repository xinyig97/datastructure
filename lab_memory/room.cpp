...
{
    if (letters != NULL)
        //memory leak because we need to free all memory allocated for the whole array
        //which means it should be delete[] instead of delete
        delete[] letters;
        letters = NULL;
}
...
void Room::copy(const Room& other)
{
    ...
    //first try : because the deep copy
    letters = new Letter[max_letters];
