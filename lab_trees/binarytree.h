...
class BinaryTree
{
  ...
  private:
    ...
    bool isOrderedRecursive_left(const Node* subroot, T data_max) const;
    bool isOrderedRecursive_right(const Node* subroot, T data_min) const;
    void printPath(vector<vector<T>> &paths, Node* subroot) const;
